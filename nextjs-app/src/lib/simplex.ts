// 3D simplex noise — shared engine for all SAID dot-field canvases.
// Ported verbatim from design/handoff/assets/said.js so the fields render
// identically to the approved design references.
