...
export default function DocsPage() {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <pre className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 mb-2 overflow-x-auto">
  ...
  -w "https://myagent.com"`}</code>
          ...
          <div className="bg-zinc-900 border-l-4 border-white rounded-r-lg p-4 mt-6">
            <p className="text-zinc-300">
              <strong>🔒 Privacy Note:</strong> Your private key never leaves your machine. We only see your public wallet address. <a href="/security" className="text-white underline">Learn more →</a>
            </p>
          </div>
        </section>
...
// }`}</code>
        ...
        <section className="mb-12">
          ...
          <p className="text-zinc-400 mb-6">Base URL: <code className="bg-zinc-800 px-2 py-1 rounded">https://api.saidprotocol.com</code></p>

          <h3 className="text-lg font-semibold mt-6 mb-4">Verification & Trust</h3>
          
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg mb-4 overflow-hidden">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <a href="https://github.com/kaiclawd/said" target="_blank" className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-600 transition">
            ...
            <a href="https://www.npmjs.com/package/said-sdk" target="_blank" className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-600 transition">
              <h3 className="font-semibold mb-1">npm Package →</h3>
              <p className="text-zinc-400 text-sm">said-sdk on npm</p>
            </a>
            <a href="https://explorer.solana.com/address/5dpw6KEQPn248pnkkaYyWfHwu2nfb3LUMbTucb6LaA8G" target="_blank" className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-600 transition">
              <h3 className="font-semibold mb-1">Solana Explorer →</h3>
              <p className="text-zinc-400 text-sm">View the deployed program</p>
            </a>
            <a href="/security" className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-600 transition">
