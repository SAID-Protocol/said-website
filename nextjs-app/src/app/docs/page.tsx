  ...
  return crypto.timingSafeEqual(
    ...
    Buffer.from(expected)
          ...
          <section id="token">
            ...
            <p><b>30% dev buy</b>: 15% locked for 1 year (long-term commitment), 15% liquid for grants, LP, and development. <b>Creator rewards</b>: trading volume generates creator rewards which flow to the treasury, funding ongoing development, agent grants, and ecosystem growth.</p>
