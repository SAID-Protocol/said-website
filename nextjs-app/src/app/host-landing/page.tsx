    ...
    <div className="host-landing-page">
      ...
      <div className="nav-wrap">
        <nav className={`nav-pill ${scrolled ? 'scrolled' : ''}`}>
          ...
          <div className="nav-div" />
          <a href="https://www.saidprotocol.com/host" className="nav-cta">Get Started</a>
        </nav>
      </div>
      ...
      <section className="hero host-layer">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="hero-btns">
            <a href="https://www.saidprotocol.com/host" className="btn-w">Start Free Trial</a>
            ...
            {plans.map((plan) => {
              ...
              return (
                <div className={`card price-card rv ${plan.featured ? 'feat' : ''}`} key={plan.name}>
                  ...
                  <a href="https://www.saidprotocol.com/host" className={`price-btn ${plan.featured ? 'pbtn-w' : 'pbtn-o'}`}>Start Free Trial</a>
                </div>
              );
            })}
          </div>
      ...
      <section className="cta host-layer">
        <div className="container">
          ...
          <a href="https://www.saidprotocol.com/host" className="btn-w rv">Start Free Trial</a>
        </div>
      </section>
