...
export default function HostDocsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950">
      ...
      <div className="flex flex-1 relative z-10 pt-24 px-6 lg:px-8 max-w-7xl mx-auto w-full gap-6">
        {/* Left Sidebar */}
        <aside className="hidden lg:block w-64 flex-shrink-0">
          <div className="sticky top-[96px] rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-5">
        ...
        {/* Main Content */}
        <main className="flex-1 max-w-4xl pb-12">

          {/* Overview */}
          <section id="overview" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
          ...
          {/* Getting Started */}
          <section id="getting-started" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Tiers & Pricing */}
          <section id="tiers" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Agent Setup */}
          <section id="agent-setup" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Skills */}
          <section id="skills" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* On-Chain Identity */}
          <section id="identity" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Billing */}
          <section id="billing" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Telegram Setup */}
          <section id="telegram" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
...
> Done! Your token is: 123456789:ABCdefGHIjklMNOpqrSTUvwxyz`}</CodeBlock>
          ...
          {/* FAQ */}
          <section id="faq" className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
            <div className="flex items-center gap-3 mb-4">
          ...
          {/* Resources */}
          <section className="mb-6 rounded-xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-8">
